...
urlpatterns = [
    ...
    path('pick', views.cosmetic_pick, name="cosmetic_pick"),
    path('delete', views.cosmetic_delete, name="cosmetic_delete"),
    path('reset', views.cosmetic_reset, name="cosmetic_reset"),
]